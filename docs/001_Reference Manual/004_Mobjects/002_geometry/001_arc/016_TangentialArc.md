...
{
  "title": "TangentialArc",
  "source_url": "https://docs.manim.community/en/stable/reference/manim.mobject.geometry.arc.TangentialArc.html",
  "tree_path": [
    "Reference Manual",
    "Mobjects",
    "geometry",
...
class TangentialArc(*line1*, *line2*, *radius*, *corner=(1, 1)*, *\*\*kwargs*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/geometry/arc.html)
:   Bases: [`ArcBetweenPoints`](https://docs.manim.community/en/stable/reference/manim.mobject.geometry.arc.ArcBetweenPoints.html)
    ...
    ![../_images/TangentialArcExample-1.png](https://docs.manim.community/en/stable/_images/TangentialArcExample-1.png)
    ...
    ![../_images/TangentialArcCorners-1.png](https://docs.manim.community/en/stable/_images/TangentialArcCorners-1.png)
    ...
    \_original\_\_init\_\_(*line1*, *line2*, *radius*, *corner=(1, 1)*, *\*\*kwargs*)
