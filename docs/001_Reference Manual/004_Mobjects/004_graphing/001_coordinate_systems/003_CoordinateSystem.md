---
{
  ...
  "source_url": "https://docs.manim.community/en/stable/reference/manim.mobject.graphing.coordinate_systems.CoordinateSystem.html",
  "tree_path": [
    "Reference Manual",
    "Mobjects",
    "graphing",
  ...
  "scraped_at": "2026-07-10T15:59:29"
}
---
...
class CoordinateSystem(*x\_range=None*, *y\_range=None*, *x\_length=None*, *y\_length=None*, *dimension=2*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
:   Bases: `object`
    ...
    | [`get_area`](#manim.mobject.graphing.coordinate_systems.CoordinateSystem.get_area) | Returns a [`Polygon`](https://docs.manim.community/en/stable/reference/manim.mobject.geometry.polygram.Polygon.html) representing the area under the graph passed. |
    | `get_axes` |  |
    | `get_axis` |  |
    | `get_axis_labels` |  |
    ...
    | [`get_origin`](#manim.mobject.graphing.coordinate_systems.CoordinateSystem.get_origin) | Gets the origin of [`Axes`](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.coordinate_systems.Axes.html). |
    | [`get_riemann_rectangles`](#manim.mobject.graphing.coordinate_systems.CoordinateSystem.get_riemann_rectangles) | Generates a [`VGroup`](https://docs.manim.community/en/stable/reference/manim.mobject.types.vectorized_mobject.VGroup.html) of the Riemann Rectangles for a given curve. |
    ...
    \_get\_axis\_label(*label*, *axis*, *edge*, *direction*, *buff=0.1*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   Gets the label for an axis.

        Parameters:
        :   - **label** (*float* *|* *str* *|* [*VMobject*](https://docs.manim.community/en/stable/reference/manim.mobject.types.vectorized_mobject.VMobject.html)) – The label. Defaults to [`MathTex`](https://docs.manim.community/en/stable/reference/manim.mobject.text.tex_mobject.MathTex.html) for `str` and `float` inputs.
            - **axis** ([*Mobject*](https://docs.manim.community/en/stable/reference/manim.mobject.mobject.Mobject.html)) – The axis to which the label will be added.
            - **edge** ([*Vector3DLike*](https://docs.manim.community/en/stable/reference/manim.typing.html)) – The edge of the axes to which the label will be added. `RIGHT` adds to the right side of the axis
            - **direction** ([*Vector3DLike*](https://docs.manim.community/en/stable/reference/manim.typing.html)) – Allows for further positioning of the label.
    ...
    add\_coordinates(*\*axes\_numbers*, *\*\*kwargs*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   Adds labels to the axes. Use `Axes.coordinate_labels` to
        access the coordinates after creation.

        Parameters:
        :   - **axes\_numbers** (*Iterable**[**float**]* *|* *None* *|* *dict**[**float**,* *str* *|* *float* *|* [*Mobject*](https://docs.manim.community/en/stable/reference/manim.mobject.mobject.Mobject.html)*]*) – The numbers to be added to the axes. Use `None` to represent an axis with default labels.
            - **kwargs** (*Any*)
    ...
    angle\_of\_tangent(*x*, *graph*, *dx=1e-08*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   Returns the angle to the x-axis of the tangent
        ...
        :   - **x** (*float*) – The x-value at which the tangent must touch the curve.
            - **graph** ([*ParametricFunction*](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ParametricFunction.html)) – The [`ParametricFunction`](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ParametricFunction.html) for which to calculate the tangent.
    ...
    c2p(*\*coords*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    ...
    get\_T\_label(*x\_val*, *graph*, *label=None*, *label\_color=None*, *triangle\_size=0.25*, *triangle\_color=ManimColor('#FFFFFF')*, *line\_func=<class 'manim.mobject.geometry.line.Line'>*, *line\_color=ManimColor('#FFFF00')*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   Creates a labelled triangle marker with a vertical line from the x-axis
        ...
        :   - **x\_val** (*float*) – The position along the curve at which the label, line and triangle will be constructed.
            - **graph** ([*ParametricFunction*](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ParametricFunction.html)) – The [`ParametricFunction`](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ParametricFunction.html) for which to construct the label.
            - **label** (*float* *|* *str* *|* [*Mobject*](https://docs.manim.community/en/stable/reference/manim.mobject.mobject.Mobject.html) *|* *None*) – The label of the vertical line and triangle.
            - **label\_color** (*TypeAliasForwardRef**(**'~manim.utils.color.core.ParsableManimColor'**)* *|* *None*) – The color of the label.
            - **triangle\_size** (*float*) – The size of the triangle.
            - **triangle\_color** (*TypeAliasForwardRef**(**'~manim.utils.color.core.ParsableManimColor'**)* *|* *None*) – The color of the triangle.
            - **line\_func** (*type**[*[*Line*](https://docs.manim.community/en/stable/reference/manim.mobject.geometry.line.Line.html)*]*) – The function used to construct the vertical line.
            - **line\_color** ([*ParsableManimColor*](https://docs.manim.community/en/stable/reference/manim.utils.color.core.html)) – The color of the vertical line.

        Returns:
        :   A [`VGroup`](https://docs.manim.community/en/stable/reference/manim.mobject.types.vectorized_mobject.VGroup.html) of the label, triangle and vertical line mobjects.
    ...
    get\_area(*graph*, *x\_range=None*, *color=(ManimColor('#58C4DD'), ManimColor('#83C167'))*, *opacity=0.3*, *bounded\_graph=None*, *\*\*kwargs*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   Returns a [`Polygon`](https://docs.manim.community/en/stable/reference/manim.mobject.geometry.polygram.Polygon.html) representing the area under the graph passed.

        Parameters:
        :   - **graph** ([*ParametricFunction*](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ParametricFunction.html)) – The graph/curve for which the area needs to be gotten.
            ...
            - **bounded\_graph** ([*ParametricFunction*](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ParametricFunction.html) *|* *None*) – If a secondary `graph` is specified, encloses the area between the two curves.
            - **kwargs** (*Any*) – Additional parameters passed to [`Polygon`](https://docs.manim.community/en/stable/reference/manim.mobject.geometry.polygram.Polygon.html).

        Returns:
        :   The [`Polygon`](https://docs.manim.community/en/stable/reference/manim.mobject.geometry.polygram.Polygon.html) representing the area.
    ...
    get\_graph\_label(*graph*, *label='f(x)'*, *x\_val=None*, *direction=array([1., 0., 0.])*, *buff=0.25*, *color=None*, *dot=False*, *dot\_config=None*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   Creates a properly positioned label for the passed graph, with an optional dot.

        Parameters:
        :   - **graph** ([*ParametricFunction*](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ParametricFunction.html)) – The curve.
            - **label** (*float* *|* *str* *|* [*VMobject*](https://docs.manim.community/en/stable/reference/manim.mobject.types.vectorized_mobject.VMobject.html)) – The label for the function’s curve. Defaults to [`MathTex`](https://docs.manim.community/en/stable/reference/manim.mobject.text.tex_mobject.MathTex.html) for `str` and `float` inputs.
            ...
            - **dot\_config** (*dict**[**str**,* *Any**]* *|* *None*) – Additional parameters to be passed to [`Dot`](https://docs.manim.community/en/stable/reference/manim.mobject.geometry.arc.Dot.html).

        Returns:
        :   The positioned label and [`Dot`](https://docs.manim.community/en/stable/reference/manim.mobject.geometry.arc.Dot.html), if applicable.
    ...
    get\_horizontal\_line(*point*, *\*\*kwargs*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   A horizontal line from the y-axis to a given point in the scene.

        Parameters:
        :   - **point** ([*Point3DLike*](https://docs.manim.community/en/stable/reference/manim.typing.html)) – The point to which the horizontal line will be drawn.
    ...
    get\_line\_from\_axis\_to\_point(*index: int*, *point: [Point3DLike](https://docs.manim.community/en/stable/reference/manim.typing.html)*, *line\_config: dict | None = None*, *color: [ParsableManimColor](https://docs.manim.community/en/stable/reference/manim.utils.color.core.html) | None = None*, *stroke\_width: float = 2*) → [DashedLine](https://docs.manim.community/en/stable/reference/manim.mobject.geometry.line.DashedLine.html)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)

    get\_line\_from\_axis\_to\_point(*index: int*, *point: [Point3DLike](https://docs.manim.community/en/stable/reference/manim.typing.html)*, *line\_func: type[[LineType](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.coordinate_systems.html)]*, *line\_config: dict | None = None*, *color: [ParsableManimColor](https://docs.manim.community/en/stable/reference/manim.utils.color.core.html) | None = None*, *stroke\_width: float = 2*) → [LineType](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.coordinate_systems.html)
    :   Returns a straight line from a given axis to a point in the scene.
        ...
        :   - **index** – Specifies the axis from which to draw the line. 0 = x\_axis, 1 = y\_axis
            ...
            - **line\_func** – The function of the [`Line`](https://docs.manim.community/en/stable/reference/manim.mobject.geometry.line.Line.html) mobject used to construct the line.
    ...
    get\_lines\_to\_point(*point*, *\*\*kwargs*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   Generate both horizontal and vertical lines from the axis to a point.

        Parameters:
        :   - **point** ([*Point3DLike*](https://docs.manim.community/en/stable/reference/manim.typing.html)) – A point on the scene.
            - **kwargs** (*Any*) – Additional parameters to be passed to [`get_line_from_axis_to_point()`](#manim.mobject.graphing.coordinate_systems.CoordinateSystem.get_line_from_axis_to_point)

        Returns:
        :   A [`VGroup`](https://docs.manim.community/en/stable/reference/manim.mobject.types.vectorized_mobject.VGroup.html) of the horizontal and vertical lines.
    ...
    get\_origin()[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   Gets the origin of [`Axes`](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.coordinate_systems.Axes.html).
    ...
    get\_riemann\_rectangles(*graph*, *x\_range=None*, *dx=0.1*, *input\_sample\_type='left'*, *stroke\_width=1*, *stroke\_color=ManimColor('#000000')*, *fill\_opacity=1*, *color=(ManimColor('#58C4DD'), ManimColor('#83C167'))*, *show\_signed\_area=True*, *bounded\_graph=None*, *blend=False*, *width\_scale\_factor=1.001*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   Generates a [`VGroup`](https://docs.manim.community/en/stable/reference/manim.mobject.types.vectorized_mobject.VGroup.html) of the Riemann Rectangles for a given curve.

        Parameters:
        :   - **graph** ([*ParametricFunction*](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ParametricFunction.html)) – The graph whose area will be approximated by Riemann rectangles.
            ...
            - **stroke\_color** ([*ParsableManimColor*](https://docs.manim.community/en/stable/reference/manim.utils.color.core.html)) – The color of the border of the rectangle.
        ...
        Returns:
        :   A [`VGroup`](https://docs.manim.community/en/stable/reference/manim.mobject.types.vectorized_mobject.VGroup.html) containing the Riemann Rectangles.
    ...
    :   Creates two lines representing dx and df, the labels for dx and df, and
        ...
        :   - **x** (*float*) – The x-value at which the secant intersects the graph for the first time.
            - **graph** ([*ParametricFunction*](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ParametricFunction.html)) – The curve for which the secant will be found.
            - **dx** (*float* *|* *None*) – The change in x after which the secant exits.
            - **dx\_line\_color** ([*ParsableManimColor*](https://docs.manim.community/en/stable/reference/manim.utils.color.core.html)) – The color of the line that indicates the change in x.
            - **dy\_line\_color** (*TypeAliasForwardRef**(**'~manim.utils.color.core.ParsableManimColor'**)* *|* *None*) – The color of the line that indicates the change in y. Defaults to the color of `graph`.
            - **dx\_label** (*float* *|* *str* *|* *None*) – The label for the dx line. Defaults to [`MathTex`](https://docs.manim.community/en/stable/reference/manim.mobject.text.tex_mobject.MathTex.html) for `str` and `float` inputs.
            - **dy\_label** (*float* *|* *str* *|* *None*) – The label for the dy line. Defaults to [`MathTex`](https://docs.manim.community/en/stable/reference/manim.mobject.text.tex_mobject.MathTex.html) for `str` and `float` inputs.
            - **include\_secant\_line** (*bool*) – Whether to include the secant line in the graph,
              or just the df/dx lines and labels.
            - **secant\_line\_color** ([*ParsableManimColor*](https://docs.manim.community/en/stable/reference/manim.utils.color.core.html)) – The color of the secant line.
    ...
    get\_vertical\_line(*point*, *\*\*kwargs*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   A vertical line from the x-axis to a given point in the scene.

        Parameters:
        :   - **point** ([*Point3DLike*](https://docs.manim.community/en/stable/reference/manim.typing.html)) – The point to which the vertical line will be drawn.
            - **kwargs** (*Any*) – Additional parameters to be passed to [`get_line_from_axis_to_point`](#manim.mobject.graphing.coordinate_systems.CoordinateSystem.get_line_from_axis_to_point).
    ...
    get\_vertical\_lines\_to\_graph(*graph*, *x\_range=None*, *num\_lines=20*, *\*\*kwargs*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   Obtains multiple lines from the x-axis to the curve.

        Parameters:
        :   - **graph** ([*ParametricFunction*](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ParametricFunction.html)) – The graph along which the lines are placed.
        ...
        Returns:
        :   The [`VGroup`](https://docs.manim.community/en/stable/reference/manim.mobject.types.vectorized_mobject.VGroup.html) of the evenly spaced lines.
    ...
    get\_x\_axis\_label(*label*, *edge=array([1., 1., 0.])*, *direction=array([1., 1., 0.])*, *buff=0.1*, *\*\*kwargs*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   Generate an x-axis label.

        Parameters:
        :   - **label** (*float* *|* *str* *|* [*VMobject*](https://docs.manim.community/en/stable/reference/manim.mobject.types.vectorized_mobject.VMobject.html)) – The label. Defaults to [`MathTex`](https://docs.manim.community/en/stable/reference/manim.mobject.text.tex_mobject.MathTex.html) for `str` and `float` inputs.
            - **edge** ([*Vector3D*](https://docs.manim.community/en/stable/reference/manim.typing.html)) – The edge of the x-axis to which the label will be added, by default `UR`.
            - **direction** ([*Vector3D*](https://docs.manim.community/en/stable/reference/manim.typing.html)) – Allows for further positioning of the label from an edge, by default `UR`.
            - **buff** (*float*) – The distance of the label from the line.
            - **kwargs** (*Any*)
    ...
    get\_y\_axis\_label(*label*, *edge=array([1., 1., 0.])*, *direction=array([1., 0.5, 0.])*, *buff=0.1*, *\*\*kwargs*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   Generate a y-axis label.

        Parameters:
        :   - **label** (*float* *|* *str* *|* [*VMobject*](https://docs.manim.community/en/stable/reference/manim.mobject.types.vectorized_mobject.VMobject.html)) – The label. Defaults to [`MathTex`](https://docs.manim.community/en/stable/reference/manim.mobject.text.tex_mobject.MathTex.html) for `str` and `float` inputs.
            - **edge** ([*Vector3D*](https://docs.manim.community/en/stable/reference/manim.typing.html)) – The edge of the y-axis to which the label will be added, by default `UR`.
            - **direction** ([*Vector3D*](https://docs.manim.community/en/stable/reference/manim.typing.html)) – Allows for further positioning of the label from an edge, by default `UR`
            - **buff** (*float*) – The distance of the label from the line.
            - **kwargs** (*Any*)
    ...
    i2gc(*x*, *graph*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   Alias for [`input_to_graph_coords()`](#manim.mobject.graphing.coordinate_systems.CoordinateSystem.input_to_graph_coords).

        Parameters:
        :   - **x** (*float*)
            - **graph** ([*ParametricFunction*](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ParametricFunction.html))

        Return type:
        :   tuple[float, float]

    i2gp(*x*, *graph*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    ...
    input\_to\_graph\_coords(*x*, *graph*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    ...
    input\_to\_graph\_point(*x*, *graph*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   Returns the coordinates of the point on a `graph` corresponding to an `x` value.

        Parameters:
        :   - **x** (*float*) – The x-value of a point on the `graph`.
            - **graph** ([*ParametricFunction*](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ParametricFunction.html) *|* [*VMobject*](https://docs.manim.community/en/stable/reference/manim.mobject.types.vectorized_mobject.VMobject.html)) – The [`ParametricFunction`](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ParametricFunction.html) on which the point lies.
    ...
    p2c(*point*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    ...
    plot(*function*, *x\_range=None*, *use\_vectorized=False*, *colorscale=None*, *colorscale\_axis=1*, *\*\*kwargs*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   Generates a curve based on a function.

        Parameters:
        :   - **function** (*Callable**[**[**float**]**,* *float**]*) – The function used to construct the [`ParametricFunction`](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ParametricFunction.html).
            ...
            - **kwargs** (*Any*) – Additional parameters to be passed to [`ParametricFunction`](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ParametricFunction.html).

        Returns:
        :   The plotted curve.

        Return type:
        :   [`ParametricFunction`](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ParametricFunction.html)
    ...
    plot\_antiderivative\_graph(*graph*, *y\_intercept=0*, *samples=50*, *use\_vectorized=False*, *\*\*kwargs*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   Plots an antiderivative graph.

        Parameters:
        :   - **graph** ([*ParametricFunction*](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ParametricFunction.html)) – The graph for which the antiderivative will be found.
            ...
            - **use\_vectorized** (*bool*) – Whether to use the vectorized version of the antiderivative. This means
              ...
              Output should be a numpy array of shape `[y_0, y_1, ...]`
            - **kwargs** (*Any*) – Any valid keyword argument of [`ParametricFunction`](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ParametricFunction.html).
    ...
    plot\_derivative\_graph(*graph*, *color=ManimColor('#83C167')*, *\*\*kwargs*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   Returns the curve of the derivative of the passed graph.

        Parameters:
        :   - **graph** ([*ParametricFunction*](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ParametricFunction.html)) – The graph for which the derivative will be found.
            - **color** ([*ParsableManimColor*](https://docs.manim.community/en/stable/reference/manim.utils.color.core.html)) – The color of the derivative curve.
            - **kwargs** (*Any*) – Any valid keyword argument of [`ParametricFunction`](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ParametricFunction.html).
    ...
    plot\_implicit\_curve(*func*, *min\_depth=5*, *max\_quads=1500*, *\*\*kwargs*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   Creates the curves of an implicit function.
        ...
        Return type:
        :   [*ImplicitFunction*](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ImplicitFunction.html)
    ...
    plot\_parametric\_curve(*function*, *use\_vectorized=False*, *\*\*kwargs*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   A parametric curve.
        ...
        :   - **function** (*Callable**[**[**float**]**,* *ndarray**]*) – A parametric function mapping a number to a point in the
              coordinate system.
            - **use\_vectorized** (*bool*) – Whether to pass in the generated t value array to the function. Only use this if your function supports it.
            - **kwargs** (*Any*) – Any further keyword arguments are passed to [`ParametricFunction`](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ParametricFunction.html).
    ...
    plot\_polar\_graph(*r\_func*, *theta\_range=None*, *\*\*kwargs*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   A polar graph.
        ...
        :   - **r\_func** (*Callable**[**[**float**]**,* *float**]*) – The function r of theta.
            ...
            - **kwargs** (*Any*) – Additional parameters passed to [`ParametricFunction`](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.functions.ParametricFunction.html).
        ...
        References: [`PolarPlane`](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.coordinate_systems.PolarPlane.html)

    plot\_surface(*function*, *u\_range=None*, *v\_range=None*, *colorscale=None*, *colorscale\_axis=2*, *\*\*kwargs*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   Generates a surface based on a function.

        Parameters:
        :   - **function** (*Callable**[**[**float**]**,* *float**]*) – The function used to construct the [`Surface`](https://docs.manim.community/en/stable/reference/manim.mobject.three_d.three_dimensions.Surface.html).
            ...
            - **colorscale\_axis** (*int*) – Defines the axis on which the colorscale is applied (0 = x, 1 = y, 2 = z), default
              is z-axis (2).
            - **kwargs** (*Any*) – Additional parameters to be passed to [`Surface`](https://docs.manim.community/en/stable/reference/manim.mobject.three_d.three_dimensions.Surface.html).

        Returns:
        :   The plotted surface.

        Return type:
        :   [`Surface`](https://docs.manim.community/en/stable/reference/manim.mobject.three_d.three_dimensions.Surface.html)
    ...
    point\_to\_polar(*point*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   Gets polar coordinates from a point.

        Parameters:
        :   **point** ([*Point2DLike*](https://docs.manim.community/en/stable/reference/manim.typing.html)) – The point.

        Returns:
        :   The coordinate radius (\(r\)) and the coordinate azimuth (\(\theta\)).

        Return type:
        :   [Point2D](https://docs.manim.community/en/stable/reference/manim.typing.html)

    polar\_to\_point(*radius*, *azimuth*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    :   Gets a point from polar coordinates.
        ...
        References: [`PolarPlane`](https://docs.manim.community/en/stable/reference/manim.mobject.graphing.coordinate_systems.PolarPlane.html) [`Vector`](https://docs.manim.community/en/stable/reference/manim.mobject.geometry.line.Vector.html)

    pr2pt(*radius*, *azimuth*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    ...
    pt2pr(*point*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
    ...
    slope\_of\_tangent(*x*, *graph*, *\*\*kwargs*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/graphing/coordinate_systems.html)
