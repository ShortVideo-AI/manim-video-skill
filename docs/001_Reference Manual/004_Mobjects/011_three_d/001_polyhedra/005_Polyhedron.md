...
{
  "title": "Polyhedron",
  "source_url": "https://docs.manim.community/en/stable/reference/manim.mobject.three_d.polyhedra.Polyhedron.html",
  "tree_path": [
    "Reference Manual",
    "Mobjects",
    "three_d",
...
class Polyhedron(*vertex\_coords*, *faces\_list*, *faces\_config={}*, *graph\_config={}*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/three_d/polyhedra.html)
:   Bases: [`VGroup`](https://docs.manim.community/en/stable/reference/manim.mobject.types.vectorized_mobject.VGroup.html)
    ...
    Parameters:
    :   - **vertex\_coords** ([*Point3DLike\_Array*](https://docs.manim.community/en/stable/reference/manim.typing.html)) – A list of coordinates of the corresponding vertices in the polyhedron. Each coordinate will correspond to
        ...
        - **graph\_config** (*dict**[**str**,* *Any**]*) – Configuration for the graph containing the vertices and edges of the polyhedron.
    ...
    \_original\_\_init\_\_(*vertex\_coords*, *faces\_list*, *faces\_config={}*, *graph\_config={}*)
    :   Initialize self. See help(type(self)) for accurate signature.

        Parameters:
        :   - **vertex\_coords** ([*Point3DLike\_Array*](https://docs.manim.community/en/stable/reference/manim.typing.html))
            - **faces\_list** (*list**[**list**[**int**]**]*)
            - **faces\_config** (*dict**[**str**,* *str* *|* *int* *|* *float* *|* *bool**]*)
            - **graph\_config** (*dict**[**str**,* *Any**]*)

    create\_faces(*face\_coords*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/three_d/polyhedra.html)
    :   Creates VGroup of faces from a list of face coordinates.

        Parameters:
        :   **face\_coords** ([*Point3DLike\_Array*](https://docs.manim.community/en/stable/reference/manim.typing.html))

        Return type:
        :   [*VGroup*](https://docs.manim.community/en/stable/reference/manim.mobject.types.vectorized_mobject.VGroup.html)

    extract\_face\_coords()[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/three_d/polyhedra.html)
    :   Extracts the coordinates of the vertices in the graph.
        Used for updating faces.

        Return type:
        :   [*Point3DLike\_Array*](https://docs.manim.community/en/stable/reference/manim.typing.html)

    get\_edges(*faces\_list*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/three_d/polyhedra.html)
