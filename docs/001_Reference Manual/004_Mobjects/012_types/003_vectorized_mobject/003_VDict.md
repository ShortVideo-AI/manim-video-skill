...
{
  "title": "VDict",
  "source_url": "https://docs.manim.community/en/stable/reference/manim.mobject.types.vectorized_mobject.VDict.html",
  "tree_path": [
    "Reference Manual",
    "Mobjects",
    "types",
  ...
  "scraped_at": "2026-07-10T16:00:34"
}
---
...
class VDict(*mapping\_or\_iterable={}*, *show\_keys=False*, *\*\*kwargs*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/types/vectorized_mobject.html)
:   Bases: [`VMobject`](https://docs.manim.community/en/stable/reference/manim.mobject.types.vectorized_mobject.VMobject.html)
    ...
    Parameters:
    :   - **mapping\_or\_iterable** (*Mapping**[**Hashable**,* [*VMobject*](https://docs.manim.community/en/stable/reference/manim.mobject.types.vectorized_mobject.VMobject.html)*]* *|* *Iterable**[**tuple**[**Hashable**,* [*VMobject*](https://docs.manim.community/en/stable/reference/manim.mobject.types.vectorized_mobject.VMobject.html)*]**]*) – The parameter specifying the key-value mapping of keys and mobjects.
    ...
    \_original\_\_init\_\_(*mapping\_or\_iterable={}*, *show\_keys=False*, *\*\*kwargs*)
    :   Initialize self. See help(type(self)) for accurate signature.

        Parameters:
        :   - **mapping\_or\_iterable** (*Mapping**[**Hashable**,* [*VMobject*](https://docs.manim.community/en/stable/reference/manim.mobject.types.vectorized_mobject.VMobject.html)*]* *|* *Iterable**[**tuple**[**Hashable**,* [*VMobject*](https://docs.manim.community/en/stable/reference/manim.mobject.types.vectorized_mobject.VMobject.html)*]**]*)
            - **show\_keys** (*bool*)

        Return type:
        :   None

    add(*mapping\_or\_iterable*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/types/vectorized_mobject.html)
    :   Adds the key-value pairs to the [`VDict`](#manim.mobject.types.vectorized_mobject.VDict) object.
        ...
        of [`Mobject`](https://docs.manim.community/en/stable/reference/manim.mobject.mobject.Mobject.html), which is responsible for actual on-screen display.
    ...
    add\_key\_value\_pair(*key*, *value*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/types/vectorized_mobject.html)
    :   A utility function used by [`add()`](#manim.mobject.types.vectorized_mobject.VDict.add) to add the key-value pair
        ...
        :   - **key** (*Hashable*) – The key of the submobject to be added.
            - **value** ([*VMobject*](https://docs.manim.community/en/stable/reference/manim.mobject.types.vectorized_mobject.VMobject.html)) – The mobject associated with the key
    ...
    get\_all\_submobjects()[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/types/vectorized_mobject.html)
    ...
    remove(*key*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/types/vectorized_mobject.html)
    :   Removes the mobject from the [`VDict`](#manim.mobject.types.vectorized_mobject.VDict) object having the key key
        ...
        of [`Mobject`](https://docs.manim.community/en/stable/reference/manim.mobject.mobject.Mobject.html), (which is responsible for removing it from the screen)
