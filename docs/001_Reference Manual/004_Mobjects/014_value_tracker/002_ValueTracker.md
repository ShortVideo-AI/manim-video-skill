---
{
  ...
  "scraped_at": "2026-07-10T16:00:40"
}
---
...
class ValueTracker(*value=0*, *\*\*kwargs*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/value_tracker.html)
:   Bases: [`Mobject`](https://docs.manim.community/en/stable/reference/manim.mobject.mobject.Mobject.html)
    ...
    increment\_value(*d\_value*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/value_tracker.html)
    ...
    interpolate(*mobject1*, *mobject2*, *alpha*, *path\_func=<function interpolate>*)[[source]](https://docs.manim.community/en/stable/_modules/manim/mobject/value_tracker.html)
    :   Turns `self` into an interpolation between `mobject1` and `mobject2`.

        Parameters:
        :   - **mobject1** ([*Mobject*](https://docs.manim.community/en/stable/reference/manim.mobject.mobject.Mobject.html))
            - **mobject2** ([*Mobject*](https://docs.manim.community/en/stable/reference/manim.mobject.mobject.Mobject.html))
            - **alpha** (*float*)
            - **path\_func** ([*PathFuncType*](https://docs.manim.community/en/stable/reference/manim.typing.html))
