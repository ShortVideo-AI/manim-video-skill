...
{
  "title": "zoomed_scene",
  "source_url": "https://docs.manim.community/en/stable/reference/manim.scene.zoomed_scene.html",
  "tree_path": [
    "Reference Manual",
    "Scenes",
    "zoomed_scene"
  ],
  "scraped_at": "2026-07-10T16:00:57"
}
---
...
| Name | Description |
| --- | --- |
| [`ZoomedScene`](https://docs.manim.community/en/stable/reference/manim.scene.zoomed_scene.ZoomedScene.html) | This is a Scene with special configurations made for when a particular part of the scene must be zoomed in on and displayed separately. |
