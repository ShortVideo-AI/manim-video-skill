---
{
  "title": "moving_camera_scene",
  "source_url": "https://docs.manim.community/en/stable/reference/manim.scene.moving_camera_scene.html",
  "tree_path": [
    "Reference Manual",
    "Scenes",
    "moving_camera_scene"
  ],
  "scraped_at": "2026-07-10T16:00:45"
}
---
...
| Name | Description |
| --- | --- |
| [`MovingCameraScene`](https://docs.manim.community/en/stable/reference/manim.scene.moving_camera_scene.MovingCameraScene.html) | This is a Scene, with special configurations and properties that make it suitable for cases where the camera must be moved around. |
