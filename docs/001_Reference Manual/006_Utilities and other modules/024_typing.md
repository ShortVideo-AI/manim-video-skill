...
{
  "title": "typing",
  "source_url": "https://docs.manim.community/en/stable/reference/manim.typing.html",
  "tree_path": [
    "Reference Manual",
    "Utilities and other modules",
    "typing"
  ],
  "scraped_at": "2026-07-10T16:01:53"
}
---
...
:   ```
    ...
    Internal color representation used by [`ManimColor`](https://docs.manim.community/en/stable/reference/manim.utils.color.core.ManimColor.html),
...
:   ```
    ...
    Do not confuse with the [`Vector`](https://docs.manim.community/en/stable/reference/manim.mobject.geometry.line.Vector.html) or [`Arrow`](https://docs.manim.community/en/stable/reference/manim.mobject.geometry.line.Arrow.html)
    VMobjects!
...
:   ```
    ...
    Do not confuse with the [`Vector`](https://docs.manim.community/en/stable/reference/manim.mobject.geometry.line.Vector.html) or [`Arrow3D`](https://docs.manim.community/en/stable/reference/manim.mobject.three_d.three_dimensions.Arrow3D.html)
    VMobjects!
...
:   ```
    ...
    Do not confuse with the [`Vector`](https://docs.manim.community/en/stable/reference/manim.mobject.geometry.line.Vector.html) VMobject! This type alias
...
class QuadraticBezierPoints\_Array
:   ```
    NDArray[PointDType]
    ```
...
class QuadraticBezierPointsLike\_Array
:   ```
...
class CubicBezierPoints\_Array
:   ```
    NDArray[PointDType]
    ```
...
class CubicBezierPointsLike\_Array
:   ```
...
:   ```
    ...
    Function type returning an [`Animation`](https://docs.manim.community/en/stable/reference/manim.animation.animation.Animation.html) for the specified
