...
{
  "title": "ManimMagic",
  "source_url": "https://docs.manim.community/en/stable/reference/manim.utils.ipython_magic.ManimMagic.html",
  "tree_path": [
    "Reference Manual",
  ...
  "scraped_at": "2026-07-10T16:01:35"
}
---
...
class ManimMagic(*\*\*kwargs*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/ipython_magic.html)
:   Bases: `Magics`
    ...
    manim(*line*, *cell=None*, *local\_ns=None*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/ipython_magic.html)
    :   Render Manim scenes contained in IPython cells.
        ...
        documentation with Sphinx and JupyterBook. See also the [`manim directive for Sphinx`](https://docs.manim.community/en/stable/reference/manim.utils.docbuild.manim_directive.html).
