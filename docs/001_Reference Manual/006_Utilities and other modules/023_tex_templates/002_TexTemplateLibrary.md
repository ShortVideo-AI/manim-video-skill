---
{
  "title": "TexTemplateLibrary",
  "source_url": "https://docs.manim.community/en/stable/reference/manim.utils.tex_templates.TexTemplateLibrary.html",
  "tree_path": [
    "Reference Manual",
  ...
  "scraped_at": "2026-07-10T16:01:51"
}
---
...
class TexTemplateLibrary[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/tex_templates.html)
:   Bases: `object`
    ...
    |  |  |
    | --- | --- |
    | [`ctex`](#manim.utils.tex_templates.TexTemplateLibrary.ctex) | An instance of the TeX template used by 3b1b when using the use\_ctex flag |
