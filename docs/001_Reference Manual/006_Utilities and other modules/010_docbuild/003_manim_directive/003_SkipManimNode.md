...
{
  "title": "SkipManimNode",
  "source_url": "https://docs.manim.community/en/stable/reference/manim.utils.docbuild.manim_directive.SkipManimNode.html",
  "tree_path": [
    "Reference Manual",
  ...
  "scraped_at": "2026-07-10T16:01:31"
}
---
...
class SkipManimNode(*rawsource=''*, *\*children*, *\*\*attributes*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/docbuild/manim_directive.html)
:   Bases: `Admonition`, `Element`
    ...
    | `common_attributes` | Tuple of [`common attributes`\_\_](#id1) known to all Doctree Element classes. |
    ...
    | `known_attributes` | Alias for common\_attributes. |
