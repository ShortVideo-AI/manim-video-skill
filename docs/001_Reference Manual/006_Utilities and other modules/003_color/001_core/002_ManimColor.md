...
{
  "title": "ManimColor",
  "source_url": "https://docs.manim.community/en/stable/reference/manim.utils.color.core.ManimColor.html",
  "tree_path": [
    "Reference Manual",
...
class ManimColor(*value*, *alpha=1.0*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
:   Bases: `object`
    ...
    The class can accept any value of type [`ParsableManimColor`](https://docs.manim.community/en/stable/reference/manim.utils.color.core.html) i.e.
    ...
    Parameters:
    :   - **value** ([*ParsableManimColor*](https://docs.manim.community/en/stable/reference/manim.utils.color.core.html) *|* *None*) – Some representation of a color (e.g., a string or
    ...
    classmethod \_construct\_from\_space(*\_space*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    ...
    :   This method is intended to be overwritten by custom color space classes
        ...
        custom class can understand. Look at [`HSV`](https://docs.manim.community/en/stable/reference/manim.utils.color.core.HSV.html) for an example.
    ...
    static \_internal\_from\_hex\_string(*hex\_*, *alpha*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    ...
    static \_internal\_from\_int\_rgb(*rgb*, *alpha=1.0*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    :   Internal function for converting an RGB tuple of integers into the internal
        ...
        *For internal use only*
        ...
        Parameters:
        :   - **rgb** ([*IntRGBLike*](https://docs.manim.community/en/stable/reference/manim.typing.html)) – Integer RGB tuple to be parsed
    ...
    static \_internal\_from\_int\_rgba(*rgba*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    :   Internal function for converting an RGBA tuple of integers into the internal
        ...
        *For internal use only*
        ...
        Parameters:
        :   **rgba** ([*IntRGBALike*](https://docs.manim.community/en/stable/reference/manim.typing.html)) – Int RGBA tuple to be parsed.
    ...
    static \_internal\_from\_rgb(*rgb*, *alpha=1.0*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    :   Internal function for converting a rgb tuple of floats into the internal
        ...
        *For internal use only*
        ...
        Parameters:
        :   - **rgb** ([*FloatRGBLike*](https://docs.manim.community/en/stable/reference/manim.typing.html)) – Float RGB tuple to be parsed.
            - **alpha** (*float*) – Optional alpha value. Default is 1.0.
    ...
    static \_internal\_from\_rgba(*rgba*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    :   Internal function for converting an RGBA tuple of floats into the internal
        ...
        *For internal use only*
        ...
        Parameters:
        :   **rgba** ([*FloatRGBALike*](https://docs.manim.community/en/stable/reference/manim.typing.html)) – Int RGBA tuple to be parsed.
    ...
    static \_internal\_from\_string(*name*, *alpha*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    ...
    property \_internal\_space: ndarray[tuple[Any, ...], dtype[TypeAliasForwardRef('~manim.typing.ManimFloat')]]
    ...
    contrasting(*threshold=0.5*, *light=None*, *dark=None*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    ...
    darker(*blend=0.2*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    ...
    classmethod from\_hex(*hex\_str*, *alpha=1.0*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    ...
    classmethod from\_hsl(*hsl*, *alpha=1.0*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    :   Create a [`ManimColor`](#manim.utils.color.core.ManimColor) from an HSL array.

        Parameters:
        :   - **hsl** ([*FloatHSLLike*](https://docs.manim.community/en/stable/reference/manim.typing.html)) – Any iterable containing 3 floats from 0.0 to 1.0.
    ...
    classmethod from\_hsv(*hsv*, *alpha=1.0*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    :   Create a [`ManimColor`](#manim.utils.color.core.ManimColor) from an HSV array.

        Parameters:
        :   - **hsv** ([*FloatHSVLike*](https://docs.manim.community/en/stable/reference/manim.typing.html)) – Any iterable containing 3 floats from 0.0 to 1.0.
            - **alpha** (*float*) – The alpha value to be used. Default is 1.0.
    ...
    classmethod from\_rgb(*rgb*, *alpha=1.0*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    ...
    classmethod from\_rgba(*rgba*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    ...
    static gradient(*colors*, *length*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    :   This method is currently not implemented. Refer to [`color_gradient()`](https://docs.manim.community/en/stable/reference/manim.utils.color.core.html) for
    ...
    interpolate(*other*, *alpha*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    ...
    into(*class\_type*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    :   Convert the current color into a different colorspace given by `class_type`,
        ...
        Parameters:
        :   **class\_type** (*type**[*[*ManimColorT*](https://docs.manim.community/en/stable/reference/manim.utils.color.core.html)*]*) – The class that is used for conversion. It must be a subclass of
        ...
        Return type:
        :   [ManimColorT](https://docs.manim.community/en/stable/reference/manim.utils.color.core.html)

    invert(*with\_alpha=False*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    ...
    lighter(*blend=0.2*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    ...
    opacity(*opacity*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    ...
    classmethod parse(*color: [ParsableManimColor](https://docs.manim.community/en/stable/reference/manim.utils.color.core.html) | None*, *alpha: float = 1.0*) → Self[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)

    classmethod parse(*color: Sequence[[ParsableManimColor](https://docs.manim.community/en/stable/reference/manim.utils.color.core.html)]*, *alpha: float = 1.0*) → list[Self]
    ...
    to\_hex(*with\_alpha=False*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    ...
    to\_hsl()[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    ...
    to\_hsv()[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    ...
    to\_int\_rgb()[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    ...
    to\_int\_rgba()[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    ...
    to\_int\_rgba\_with\_alpha(*alpha*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    ...
    to\_integer()[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    ...
    to\_rgb()[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    ...
    to\_rgba()[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
    ...
    to\_rgba\_with\_alpha(*alpha*)[[source]](https://docs.manim.community/en/stable/_modules/manim/utils/color/core.html)
